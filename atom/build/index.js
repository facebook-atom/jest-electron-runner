...
var _AtomTestWorkerFarm = require('./AtomTestWorkerFarm');var _AtomTestWorkerFarm2 = _interopRequireDefault(_AtomTestWorkerFarm);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
 ...
 */ /* This is the main file that Jest will specify in its config as
     ...
     */ /* eslint-disable nuclide-internal/no-commonjs */let ipcServerPromise;let serverID;let farm;let cleanupRegistered = false;class TestRunner {constructor(globalConfig) {this._globalConfig = globalConfig;serverID = serverID || (serverID = (0, _utils.makeUniqServerId)());
    ipcServerPromise || (
  ...
  options)
  {
    ...
    if (!farm) {
      farm = new _AtomTestWorkerFarm2.default({
        serverID: this._serverID,
