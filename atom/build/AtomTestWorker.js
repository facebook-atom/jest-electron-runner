 ...
 */ /* This is a Jest worker. An abstraction class that knows how to start up
      * an Atom process and communicate with it */ /* eslint-disable nuclide-internal/prefer-nuclide-uri */ /* eslint-disable-next-line nuclide-internal/consistent-import-name */const createDummyPackageJson = () => {_mkdirp2.default.sync(_path2.default.resolve(TMP_DIR));const packageJsonPath = _path2.default.resolve(TMP_DIR, 'package.json');_fs2.default.writeFileSync(packageJsonPath, JSON.stringify({ atomTestRunner: require.resolve('./atomTestRunner') }));};
class AtomTestWorker {
  ...
  async start() {
    ...
    return new Promise(resolve => {
      ...
      const atomPathArg = _path2.default.resolve(
      TMP_DIR,
      (0, _utils.mergeIPCIDs)({ serverID, workerID }));
